...
|---------------|------------------|----------------|
| Matplotlib, Seaborn, Plotly, Dash, Bokeh, Folium | Power BI, Tableau, Knime, Google Data Studio, Neo4j | Jupyter, VS Code, Colab, PyCharm |
...
|----------------|-----------|
| Classification | Accuracy, Precision, Recall, F1-score, AUC-ROC, Log Loss, MCC, Matrice de confusion |
| Régression | R² Score, MAE, RMSE |
| Clustering | Silhouette Score, Dunn Index, ARI |
| NLP | Perplexité, BLEU, ROUGE |
| Vision par ordi. | Top-K Accuracy, IoU, MAP |
| Robustesse & Drift | Kolmogorov-Smirnov, Jensen-Shannon, Chi², Evidently AI |
...
|---------------------|--------------------------|
| ANOVA, Pearson, Shapiro, Bartlett, Levene | Spearman, Kendall, Mann-Whitney, KS-Test, Fligner-Killeen |
| Test t de Student | Hypothèses H₀ / H₁ |
...
|------------------|---------------|------------------|
| AWS (S3, EMR, Lambda, SageMaker), Azure, GCP | MLflow, Docker, Jenkins, GitHub Actions, GitLab CI/CD | Kafka, Airflow, Spark Streaming, PySpark, Hadoop |
...
|-------------|------------------|---------|
| FastAPI, Flask, Streamlit, Dash | Docker, Kubernetes (AKS, EKS, GKE) | TensorFlow Serving, TorchServe, ONNX |
...
|------------------|-------------------|-------------|
| SCRUM (Sprint, Planning, Rétrospective) | Jira, Trello, Confluence, MS-Project | RGPD, IAM (gestion des accès) |
